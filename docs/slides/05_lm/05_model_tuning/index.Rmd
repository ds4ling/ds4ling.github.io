...
rmarkdown::render("./static/slides/05_lm/05_model_tuning/index.Rmd")
xaringan::inf_mr()
```
...
source('./assets/scripts/model_tuning.R')
```
...
```{r, 'lex_decision_rt', cache=TRUE, echo=FALSE, fig.width=10.5, fig.height=6, out.extra="style=float:right"}
rt_df %>% 
...
---
background-image: url(./assets/img/int1.png)
background-position: 90% 70%
background-size: 800px

```{r, 'int1', cache=TRUE, eval=FALSE, echo=FALSE, fig.width=10.5, fig.height=6, out.extra="style=float:right"}
tribble(
  ~'Group', ~'Condition', ~'Val', ~'lower', ~'upper', 
   'Group1',  'Control',    25,     3.5,      3.5, 
   'Group2',  'Control',    25,     3.5,      3.5, 
   'Group1',  'Treatment',  25,     3.5,      3.5, 
   'Group2',  'Treatment',  25,     3.5,      3.5
) %>% 
  ggplot(., aes(x = Group, y = Val, color = Condition)) + 
    geom_errorbar(aes(ymin = Val - lower, ymax = Val + upper), 
...
<div align="right">
<img src="./assets/img/no_int.png">
<img width="160" src="../../assets/img/fill.png">
</div>

---
background-image: url(./assets/img/int2.png)
background-position: 90% 70%
background-size: 800px

```{r, 'int2', cache=TRUE, eval=FALSE, echo=FALSE, fig.width=10.5, fig.height=6, out.extra="style=float:right"}
tribble(
  ~'Group', ~'Condition', ~'Val', ~'lower', ~'upper', 
   'Group1',  'Control',    15,     3.5,      3.5, 
   'Group2',  'Control',    35,     3.5,      3.5, 
   'Group1',  'Treatment',  15,     3.5,      3.5, 
   'Group2',  'Treatment',  35,     3.5,      3.5
) %>% 
  ggplot(., aes(x = Group, y = Val, color = Condition)) + 
    geom_errorbar(aes(ymin = Val - lower, ymax = Val + upper), 
                  width = 0.1, color = 'black') + 
...
---
background-image: url(./assets/img/int3.png)
background-position: 90% 70%
background-size: 800px

```{r, 'int3', cache=TRUE, eval=FALSE, echo=FALSE, fig.width=10.5, fig.height=6, out.extra="style=float:right"}
tribble(
  ~'Group', ~'Condition', ~'Val', ~'lower', ~'upper', 
   'Group1',  'Control',    15,     3.5,      3.5, 
   'Group2',  'Control',    15,     3.5,      3.5, 
   'Group1',  'Treatment',  35,     3.5,      3.5, 
   'Group2',  'Treatment',  35,     3.5,      3.5
) %>% 
  ggplot(., aes(x = Group, y = Val, color = Condition)) + 
    geom_errorbar(aes(ymin = Val - lower, ymax = Val + upper), 
...
---
background-image: url(./assets/img/int4.png)
background-position: 90% 70%
background-size: 800px

```{r, 'int4', cache=TRUE, eval=FALSE, echo=FALSE, fig.width=10.5, fig.height=6, out.extra="style=float:right"}
tribble(
  ~'Group', ~'Condition', ~'Val', ~'lower', ~'upper', 
   'Group1',  'Control',    10,     3.5,      3.5, 
   'Group2',  'Control',    20,     3.5,      3.5, 
   'Group1',  'Treatment',  30,     3.5,      3.5, 
   'Group2',  'Treatment',  40,     3.5,      3.5
) %>% 
  ggplot(., aes(x = Group, y = Val, color = Condition)) + 
    geom_errorbar(aes(ymin = Val - lower, ymax = Val + upper), 
                  width = 0.1, color = 'black') + 
...
---
background-image: url(./assets/img/int5.png)
background-position: 90% 70%
background-size: 800px

```{r, 'int5', cache=TRUE, eval=FALSE, echo=FALSE, fig.width=10.5, fig.height=6, out.extra="style=float:right"}
tribble(
  ~'Group', ~'Condition', ~'Val', ~'lower', ~'upper', 
   'Group1',  'Control',    15,     3.5,      3.5, 
   'Group2',  'Control',    35,     3.5,      3.5, 
   'Group1',  'Treatment',  35,     3.5,      3.5, 
   'Group2',  'Treatment',  15,     3.5,      3.5
) %>% 
  ggplot(., aes(x = Group, y = Val, color = Condition)) + 
    geom_errorbar(aes(ymin = Val - lower, ymax = Val + upper), 
                  width = 0.1, color = 'black') + 
...
---
background-image: url(./assets/img/int6.png)
background-position: 90% 70%
background-size: 800px

```{r, 'int6', cache=TRUE, eval=FALSE, echo=FALSE, fig.width=10.5, fig.height=6, out.extra="style=float:right"}
tribble(
  ~'Group', ~'Condition', ~'Val', ~'lower', ~'upper', 
   'Group1',  'Control',    25,     3.5,      3.5, 
   'Group2',  'Control',    25,     3.5,      3.5, 
   'Group1',  'Treatment',  10,     3.5,      3.5, 
   'Group2',  'Treatment',  40,     3.5,      3.5
) %>% 
  ggplot(., aes(x = Group, y = Val, color = Condition)) + 
    geom_errorbar(aes(ymin = Val - lower, ymax = Val + upper), 
...
---
background-image: url(./assets/img/int7.png)
background-position: 90% 70%
background-size: 800px

```{r, 'int7', cache=TRUE, eval=FALSE, echo=FALSE, fig.width=10.5, fig.height=6, out.extra="style=float:right"}
tribble(
  ~'Group', ~'Condition', ~'Val', ~'lower', ~'upper', 
   'Group1',  'Control',    45,     3.5,      3.5, 
   'Group2',  'Control',    30,     3.5,      3.5, 
   'Group1',  'Treatment',  5,      3.5,      3.5, 
   'Group2',  'Treatment',  20,     3.5,      3.5
) %>% 
  ggplot(., aes(x = Group, y = Val, color = Condition)) + 
    geom_errorbar(aes(ymin = Val - lower, ymax = Val + upper), 
                  width = 0.1, color = 'black') + 
...
---
background-image: url(./assets/img/int8.png)
background-position: 90% 70%
background-size: 800px

```{r, 'int8', cache=TRUE, eval=FALSE, echo=FALSE, fig.width=10.5, fig.height=6, out.extra="style=float:right"}
tribble(
  ~'Group', ~'Condition', ~'Val', ~'lower', ~'upper', 
   'Group1',  'Control',    45,     3.5,      3.5, 
   'Group2',  'Control',    45,     3.5,      3.5, 
   'Group1',  'Treatment',  10,     3.5,      3.5, 
   'Group2',  'Treatment',  40,     3.5,      3.5
) %>% 
  ggplot(., aes(x = Group, y = Val, color = Condition)) + 
...
.pull-right[
```{r, 'int_main_effects1', cache=TRUE, eval=TRUE, echo=FALSE, fig.width=10, fig.height=6}
tribble(
  ~'Group', ~'Condition', ~'Val', ~'lower', ~'upper', 
  ...
  ggplot(., aes(x = Group, y = Val, color = Condition)) + 
    ...
    ylim(0, 50) + 
    scale_color_brewer(palette = "Set1") + 
    scale_x_continuous(breaks = c(1, 2), labels = c('Group 1', 'Group 2')) + 
    theme_test(base_family = 'Times', base_size = 26)
```
]
...
fact that the treatment had no effect of group 2. 

]

.pull-right[
```{r, 'int_main_effects2', cache=TRUE, eval=TRUE, echo=FALSE, fig.width=10, fig.height=6}
tribble(
  ~'Group', ~'Condition', ~'Val', ~'lower', ~'upper', 
   1,  'Control',    45,     3.5,      3.5, 
   2,  'Control',    45,     3.5,      3.5, 
...
.pull-left[
- Collapsing over *condition*, there is a difference between group 1 and group 
2, i.e., the difference in means is not 0. 

- Thus, one might interpret the main effect as something like 
"Overall, group 2 had higher average scores than group 1". 

- Technically this is "true", but careless, as it does not take into account the 
fact that the treatment is only effective on group 1. 
]

.pull-right[
```{r, 'int_main_effects3', cache=TRUE, eval=TRUE, echo=FALSE, fig.width=10, fig.height=6}
tribble(
  ~'Group', ~'Condition', ~'Val', ~'lower', ~'upper', 
   1,  'Control',    45,     3.5,      3.5, 
   2,  'Control',    45,     3.5,      3.5, 
...
```{r, 'lang_div_plots1', echo=FALSE, fig.height=4.5}
tidy_lang_div %>% 
...
```{r, 'lang_div_plots2', echo=FALSE, fig.height=4.5}
tidy_lang_div %>% 
...
ex_a %>% 
  ggplot(., aes(x, y, color = group)) + 
    ...
    scale_color_brewer(palette = "Set1") + 
    geom_smooth(method = lm, se = F) + 
    theme_test(base_family = "Times", base_size = 22)
```
